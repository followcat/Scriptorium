...
| Transformer-XL 第 1 页 | 116 / 99 | `0.94267969` | Pair `1.0`，successor `1.0` | 49 个元素使用 partial-order fusion，已标注正确性不变。 |
| JD 首页第 1 页 | 160 / 128 | `0.99536129` | 尚无 semantic sidecar | successor-consensus disagreement 减少 58；但模型没有 relation/stream edge，stream `needs-structure-evidence` 增加 2。 |
