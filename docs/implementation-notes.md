...
- `html_mode`: benchmarked HTML rendering mode, currently `structured` or `fidelity`. `structured` redraws editable elements; `fidelity` prints SVG page backgrounds while preserving transparent coordinate/edit anchors in the HTML.
