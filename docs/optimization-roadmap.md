...
1. Expand real semantic ground truth for complex PDFs
   ...
   The arXiv Attention sidecar now covers 5 representative pages and 38 labeled text nodes. The Transformer-XL sidecar covers 3 real ACL two-column pages and 44 labeled text nodes. Expand this to more pages and more document families, especially equations, tables, footnotes, appendices, manuals, and web-to-PDF pages.
