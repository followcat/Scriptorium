...
- `reading_order_stream_id`、`reading_order_stream_type`、`reading_order_stream_index`，用于标记 page-local reading streams，例如 `body-main`、`footnote`、`sidebar-right`、`page-artifact-header`、`caption-figure-*`、`table-island-001`。
