<p align="right">
  <strong>简体中文</strong>
  |
  <a href="implementation-notes.md">English</a>
</p>
...
- `infer_successor_consensus_order()`: 汇总 visual-yx、box-flow、relation-graph 和 external-structure 的相邻后继边，生成 acyclic path-cover 候选。
