...
| Sample | Visual Similarity | Semantic Order | Reading Risk | RO Confidence | Captions | Box-Flow Elements | Box-Flow Disagreement | Spatial Graph | Table Row-Major | Footnotes | Sidebars | Evidence Highlights |
|---|---:|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| Built-in fixtures | 0.9906702 | 1.0 | `5 low` | 0.80113208 | 0 | 0 | 0.19494585 | 0 | 18 | 0 | 0 | `table-row-major`, `recursive-xy-cut`, whitespace cuts |
| Transformer-XL first 3 pages | 0.98160664 | 1.0 | `0.21573209 / medium` | 0.9552648 | 3 figure, 1 cross-column | 0 | 0.0825672 | 0 | 0 | 7 | 0 | `column-flow`, `caption-label`, `cross-column-caption`, `footnote-secondary-flow` |
| PUMA 2024 Annual Report first 12 pages | 0.9795117 | n/a | `0.35 / high` | 0.82476488 | 0 | 0 | 0.17460108 | 0 | 0 | 2 | 36 right | `sidebar-secondary-flow`, `footnote-secondary-flow`, `table-island-row-major` |
| JD homepage screenshot PDF | 0.99576887 | n/a | `0.35 / high` | 0.83 | 0 | 0 | 0.42778588 | 0 | 0 | 0 | 0 | `recursive-xy-cut`, OCR coordinate anchors |
