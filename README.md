...
Current spatial-graph v1 spot checks:

| Sample | Visual Similarity | Semantic Order | Reading Risk | RO Confidence | Spatial Graph | Table Row-Major | Footnotes | Sidebars | Low-Confidence RO | Evidence Highlights |
|---|---:|---:|---|---:|---:|---:|---:|---:|---:|---|
| Built-in fixtures | 0.9906702 | 1.0 | `5 low` | 0.80113208 | 0 | 18 | 0 | 0 | 0 | `table-row-major`, `recursive-xy-cut`, whitespace cuts |
| Transformer-XL first 3 pages | 0.98160664 | 1.0 | `0.21573209 / medium` | 0.9552648 | 0 | 0 | 7 | 0 | 0 | `column-flow`, `repeated-left-edge`, `footnote-secondary-flow` |
| PUMA 2024 Annual Report first 12 pages | 0.9795117 | n/a | `0.35 / high` | 0.82476488 | 0 | 0 | 2 | 36 right | 0 | `sidebar-secondary-flow`, `footnote-secondary-flow`, `table-island-row-major` |
| JD homepage screenshot PDF | 0.99576887 | n/a | `0.35 / high` | 0.83 | 0 | 0 | 0 | 0 | 0 | `recursive-xy-cut`, OCR coordinate anchors |
...
- `src/scriptorium/reading_order.py`: visual order, recursive XY-Cut, column-flow, spatial graph, table row-major, table-island, artifact, sidebar, and footnote semantic order
