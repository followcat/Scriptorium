...
def _structure_ab_case_comparison(native_case: dict[str, Any], structure_case: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "structure_evidence_derived_block_stream_count": structure_case[
            "structure_evidence_derived_block_stream_count"
        ],
        "structure_evidence_derived_block_stream_member_count": structure_case[
            "structure_evidence_derived_block_stream_member_count"
        ],
...
def _summarize_structure_ab_comparisons(comparisons: list[dict[str, Any]]) -> dict[str, Any]:
    return {
        ...
        "total_structure_evidence_derived_block_streams": sum(
            int(values["structure_evidence_derived_block_stream_count"]) for values in comparisons
        ),
        "total_structure_evidence_derived_block_stream_members": sum(
            int(values["structure_evidence_derived_block_stream_member_count"]) for values in comparisons
        ),
...
def _run_case(
    ...
    return {
        ...
        "structure_evidence_derived_block_stream_count": stats[
            "structure_evidence_derived_block_stream_count"
        ],
        "structure_evidence_derived_block_stream_member_count": stats[
            "structure_evidence_derived_block_stream_member_count"
        ],
...
def _document_stats(document: DocumentIR) -> dict[str, Any]:
    ...
    return {
        ...
        **successor_consensus_diagnostics,
        ...
        "structure_evidence_derived_block_stream_count": int(
            structure_evidence.get("derived_block_stream_count") or 0
        ),
        "structure_evidence_derived_block_stream_member_count": int(
            structure_evidence.get("derived_block_stream_member_count") or 0
        ),
...
def _summarize(cases: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "total_structure_evidence_derived_block_streams": sum(
            int(case["structure_evidence_derived_block_stream_count"]) for case in cases
        ),
        "total_structure_evidence_derived_block_stream_members": sum(
            int(case["structure_evidence_derived_block_stream_member_count"]) for case in cases
        ),
        "total_structure_evidence_matched_elements": sum(
